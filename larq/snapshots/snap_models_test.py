...
snapshots['test_save_summary 1'] = '''Layer,Input precision (bits),Output dimension 1,Output dimension 2,Output dimension 3,# 1-bit x 1,# 2-bit x 1,# 32-bit x 1,Memory (kB),1-bit MACs,2-bit MACs,32-bit MACs\r
quant_conv2d,-,64,64,32,288,0,32,0.16015625,0,0,1179648\r
max_pooling2d,-,32,32,32,0,0,0,0,0,0,0\r
quant_depthwise_conv2d,2,11,11,32,0,288,0,0.0703125,0,34848,0\r
quant_separable_conv2d,1,11,11,32,1312,0,32,0.28515625,158752,0,0\r
flatten,-,,,3872,0,0,0,0,0,0,0\r
dense,-,,,10,0,0,38730,151.2890625,0,0,38720\r
